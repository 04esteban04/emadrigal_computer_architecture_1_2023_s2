...
def Asm():
    ...
    comandos = [
        "sudo arm-none-eabi-as main.s -march=armv7-a -mfloat-abi=hard -mfpu=vfpv3 -g -o main.o",
        "sudo arm-none-eabi-as itoa.s -march=armv7-a -mfloat-abi=hard -mfpu=vfpv3 -g -o itoa.o",
        "sudo arm-none-eabi-ld main.o itoa.o -o main",
    ]
...
def meterTxt():
    # Ruta de la imagen
    imagen_path = '/home/daval/Escritorio/Arqui/Proyecto_1/emadrigal_computer_architecture_1_2023_s2/assets/sekiroGris.jpg'
...
labelImagenObtenida = ttk.Label(ventana, text="Imagen obtenida")
...
cargarImagenOriginal("assets/sekiroGris.jpg")

# Cargar las imágenes automáticamente al iniciar la aplicación
cargar_imagenes("assets/sekiroGris.jpg")

# Crear un botón en el medio de la ventana
boton = ttk.Button(ventana, text="Haz clic aquí", command=accion_del_boton)
